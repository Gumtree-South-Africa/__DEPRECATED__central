...
public class AdImageLookup {
    ...
    public AdImageLookup(String mobilepushUrl, Integer apiPort) {
        // very low timeouts to not hurt backend
        this.httpClient = buildHttpClient(1000, 1000, 2000, 40, 40);
        this.mobilepushHost = new HttpHost(mobilepushUrl, apiPort);
    }
    ...
    public String lookupAdImageUrl(Long adId) {
        ...
        try {
            ...
            return httpClient.execute(mobilepushHost, request, new AdImageUrlResponseHandler());
