...
public class RiakPostBoxRepository implements PostBoxRepository {

    private static final Logger LOG = LoggerFactory.getLogger(RiakPostBoxRepository.class);
    ...
    @Autowired
    RiakPostBoxRepository(IRiakClient riakClient, String bucketNamePrefix) {
        try {
    ...
    public Optional<ConversationThread> getConversationThread(String postBoxId, String conversationId) {
        PostBox postBox = byId(postBoxId);
