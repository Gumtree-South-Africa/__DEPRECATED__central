...
public class PushMessageOnNewReplyTest {
    ...
    public void setUp() {
        ...
        listener = new PushMessageOnNewReply(pushService, adImageLookup, conversation, message);
    }
