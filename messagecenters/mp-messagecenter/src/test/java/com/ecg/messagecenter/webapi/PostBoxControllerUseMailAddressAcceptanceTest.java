...
public class PostBoxControllerUseMailAddressAcceptanceTest {
    ...
    public void readConversation() {
        ...
        RestAssured.given()
                ...
                .get("http://localhost:" + testRule.getHttpPort() + "/msgcenter/postboxes/seller1@seller.com");
    }
    ...
    public void readMessages() throws Exception {
        ...
        RestAssured.given()
                ...
                .get("http://localhost:" + testRule.getHttpPort() + "/msgcenter/postboxes/seller1@seller.com/conversations/" + conversationId);
    }
    ...
    public void deleteConversation() {
        ...
        RestAssured.given()
                .expect()
                .statusCode(200)
                .delete("http://localhost:" + testRule.getHttpPort() + "/msgcenter/postboxes/seller1@seller.com/conversations?ids=" + conversationId);
    ...
    public void resetMessageCounter() {
        ...
        RestAssured.given()
                ...
                .put("http://localhost:" + testRule.getHttpPort() + "/msgcenter/postboxes/seller1@seller.com");
