...
public class PostBoxConverterTest {
    ...
    private PostBox createPostBox() {
        ...
        return new PostBox("bla@blah.com", Lists.newArrayList(
                new ConversationThread("123", "abc", createdAt1, modifiedAt1, receivedAt1, 1, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.of(receivedAt1)),
                new ConversationThread("321", "cba", createdAt2, modifiedAt2, receivedAt2, 0, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.of(receivedAt1))
        ));
    }
    ...
    public void constructDeconstructPostboxGzipped() {
        ...
        assertEquals(postBox.getUserId(), converted.getUserId());
    }
    ...
    public void receivedAtIsNullSafeDeconstruct() {
        PostBox postBox = new PostBox("bla@blah.com", Lists.newArrayList(
                new ConversationThread("321", "cba", now(), now(), null, 0, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.of(now()))));
