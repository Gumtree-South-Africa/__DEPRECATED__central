...
import com.ecg.messagecenter.persistence.riak.PostBoxesMerger;
...
public class PostBoxesMergerTest {
    ...
    private ConversationThread createConvThread(DateTime modifiedAt, String convId) {
        ...
        return new ConversationThread("123", convId, CREATED_AT, modifiedAt, receivedDate, 0, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.<Long>absent(), Optional.of(receivedDate));
