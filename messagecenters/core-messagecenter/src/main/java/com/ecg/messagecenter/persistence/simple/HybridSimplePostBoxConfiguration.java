...
public class HybridSimplePostBoxConfiguration {
    ...
    @Bean
    public CassandraSimplePostBoxRepository cassandraSimplePostBoxRepository(@Qualifier("cassandraSessionForMb") Session cassandraSession,
                                                                             ConsistencyLevel cassandraReadConsistency, ConsistencyLevel cassandraWriteConsistency) {
