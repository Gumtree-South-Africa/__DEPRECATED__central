...
public class PostBoxConverterTest {
    ...
    public void receivedAtIsNullSafeDeconstruct(){
        PostBox postBox = new PostBox("bla@blah.com", Optional.of(1l), Lists.newArrayList(
                new ConversationThread("321", "cba", now(), now(), null, false, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent())));
    ...
    private PostBox createPostBox() {
        ...
        return new PostBox("bla@blah.com", Optional.of(1L), Lists.newArrayList(
                new ConversationThread("123", "abc", createdAt1, modifiedAt1, receivedAt1, true, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent()),
                new ConversationThread("321", "cba", createdAt2, modifiedAt2, receivedAt2, false, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent()),
                new ConversationThread("213", "bca", createdAt3, modifiedAt3, receivedAt3, false, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent())
        ));
    }
