...
public class PostBoxConflictResolverTest {
    ...
    private ConversationThread createConvThread(DateTime modifiedAt, String convId) {
        ...
        return new ConversationThread("123", convId, CREATED_AT, modifiedAt, receivedDate, false, Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent(), Optional.<String>absent());
