...
public class McToMbSyncAcceptanceTest extends SyncTestBase {
    ...
    public void markConversationAsReadShouldBeInSync() {
        ...
        // Checking that conversation is still unread
        RestAssured.given()
                .expect()
                .statusCode(200)
        ...
        RestAssured.given()
                .expect()
                .statusCode(200)
                .body("unreadMessagesCount", equalTo(1))
        ...
        RestAssured.put("http://localhost:" + testRule.getHttpPort() + "/ebayk-msgcenter/postboxes/" + TO.value + "/conversations/" + conversationId);

        // Checking that conversations is successfully marked as read
        RestAssured.given()
                .expect()
                .statusCode(200)
