...
public class MessagesResponseFactoryTest {
    ...
    @Ignore
    @Test
    public void diffSubsequentMessages() throws Exception {
        ...
        verify(differ, times(1)).diff(new MessagesDiffer.DiffInput("firstMessage", null, null), new MessagesDiffer.DiffInput("secondMessage", null, null));
        verify(differ, times(1)).diff(new MessagesDiffer.DiffInput("secondMessage", null, null), new MessagesDiffer.DiffInput("thirdMessage", null, null));
    }
    ...
    public void lastItemForIntialContactPosterWhenNoReplies() {
        ...
        assertEquals("cleanedUpFirstMessage", messageStripper.latestMessage(BUYER, conv).get().getTextShort());
    }
    ...
    @Ignore
    @Test
    public void diffAlwaysOnLastOtherRole() {
        addMessage("firstMessage", BUYER_TO_SELLER);
        addMessage("secondMessage", SELLER_TO_BUYER);
        ...
        verify(differ).diff(argThat(new MessageTextMatcher("firstMessage")), argThat(new MessageTextMatcher("secondMessage")));
        verify(differ).diff(argThat(new MessageTextMatcher("firstMessage")), argThat(new MessageTextMatcher("thirdMessage")));
    }
    ...
    @Test
    public void doNotIncludeRobotMessageIfRoleIsSellerAndDirectionIsSellerToBuyer() {
        addMessage("firstMessage", MessageState.SENT, BUYER_TO_SELLER, "desktop");
    ...
    @Test
    public void doNotIncludeRobotMessageIfRoleIsBuyerAndDirectionIsBuyerToSeller() {
        addMessage("firstMessage", MessageState.SENT, BUYER_TO_SELLER, "desktop");
        addMessage("secondMessage", MessageState.SENT, SELLER_TO_BUYER, "desktop");
    ...
    @Test
    public void doNotIncludeRobotMessageIfRobotDisabled() {
        addMessage("firstMessage", MessageState.SENT, BUYER_TO_SELLER, "desktop");
        addMessage("robotMessage", MessageState.SENT, SELLER_TO_BUYER, "desktop", true);
    ...
    @Test
    public void includeRobotMessageIfRobotEnabled() {
        addMessage("firstMessage", MessageState.SENT, BUYER_TO_SELLER, "desktop");
        addMessage("robotMessage", MessageState.SENT, SELLER_TO_BUYER, "desktop", true);
    ...
    private void addMessage(String text, MessageState state, MessageDirection messageDirection, boolean isRobotMessage) {
