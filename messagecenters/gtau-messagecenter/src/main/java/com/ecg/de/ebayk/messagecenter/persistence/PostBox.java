...
public class PostBox {
    ...
    public Map<String, ConversationThread> getUnreadConversationsCapped() {
        return getUnreadConversationsInternal(of(MessageCenterConstants.MAX_DISPLAY_CONVERSATIONS_TO_USER));
    }
    ...
    private List<ConversationThread> cleanupAndSortByReceivedDate(List<ConversationThread> conversationThreads) {
        ...
        Collections.sort(tmp, new Comparator<ConversationThread>() {
            @Override
            public int compare(ConversationThread o1, ConversationThread o2) {
                return DateTimeComparator.getInstance().compare(o2.getReceivedAt(), o1.getReceivedAt());
