...
import com.ecg.messagecenter.bt.pushmessage.KmobileAdImageLookup;
 ...
 */
public class KmobileAdImageLookupTest {
    ...
    public void adWithImages() throws Exception {
        ...
        String url = new KmobileAdImageLookup.AdImageUrlResponseHandler().handleResponse(httpResponse);
