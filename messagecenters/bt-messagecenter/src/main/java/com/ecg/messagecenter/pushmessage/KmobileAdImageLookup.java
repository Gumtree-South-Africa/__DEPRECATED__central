 ...
 */
public class KmobileAdImageLookup extends AdImageLookup {

    private static final Logger LOG = LoggerFactory.getLogger(KmobileAdImageLookup.class);

    private final HttpClient httpClient;
    private final HttpHost kmobilepushHost;

    public KmobileAdImageLookup(String kapiHost, Integer kapiPort) {
