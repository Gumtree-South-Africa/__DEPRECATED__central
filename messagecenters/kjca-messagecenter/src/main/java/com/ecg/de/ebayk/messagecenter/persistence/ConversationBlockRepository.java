...
public class ConversationBlockRepository {
    static final String BUCKET_NAME = "conversation_block";
    static final String CREATED_INDEX = "createdAt";

    private static final Logger LOG = LoggerFactory.getLogger(ConversationBlockRepository.class);
    ...
    private final Converter<ConversationBlock> converter;
    private final ConflictResolver<ConversationBlock> resolver;

    ConversationBlockRepository(IRiakClient riakClient) {
        this(riakClient, "");
    }
    ...
    ConversationBlockRepository(
        ...
        this.converter = new ConversationBlockConverter(bucketName);
        this.resolver = new ConversationBlockConflictResolver();
