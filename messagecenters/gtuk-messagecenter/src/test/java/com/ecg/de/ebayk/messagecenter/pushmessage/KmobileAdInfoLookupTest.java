...
public class KmobileAdInfoLookupTest {
    ...
    public void adWithImages() throws Exception {
        ...
        assertEquals("http://i.ebayimg.com/00/s/NjQwWDEwMjQ=/z/ZIAAAOxy4dNS8gay/$_{imageId}.JPG", adInfo.get().getImageUrl());
        assertEquals("Rc Scaler und&#x2F;oder Crawler fahrer gesucht nähe  Meiningen", adInfo.get().getTitle());
    }
