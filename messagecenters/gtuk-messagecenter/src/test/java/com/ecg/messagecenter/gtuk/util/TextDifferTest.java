...
import com.ecg.messagecenter.gtuk.util.TextDiffer;
...
public class TextDifferTest {
    ...
    public void textCleaner() throws Exception {
        ...
        Assert.assertEquals(new TextDiffer.NGram("das", " ", DOESNT_MATTER), cleaner.getNgramsOfText().get(0));
        Assert.assertEquals(new TextDiffer.NGram("ist", " ", DOESNT_MATTER), cleaner.getNgramsOfText().get(1));
        Assert.assertEquals(new TextDiffer.NGram("ein", "\n", DOESNT_MATTER), cleaner.getNgramsOfText().get(2));
        Assert.assertEquals(new TextDiffer.NGram("text", "", DOESNT_MATTER), cleaner.getNgramsOfText().get(3));
    }
    ...
    public void findMatch() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("das", " ", DOESNT_MATTER));

        assertEquals(1, cleaner.getIndexedMatches().size());
        Assert.assertEquals(new TextDiffer.NGramMatch(new TextDiffer.NGram("das", " ", DOESNT_MATTER), 0), cleaner.getIndexedMatches().keySet().iterator().next());
    }
    ...
    public void cleanupMatches() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("das", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("ist", " ", DOESNT_MATTER));
    ...
    public void multipleOccurences() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("ist", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("ein", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("ist", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("super", "", DOESNT_MATTER));
    ...
    public void greedySnipAway1() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("zitate", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("sind", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("blöd", "", DOESNT_MATTER));
    ...
    public void greedySnipAway2() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("zitat", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("toll", "", DOESNT_MATTER));
    ...
    public void resetOnNonFound() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("Huhu", "", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("Nicht", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("da?", "\n", DOESNT_MATTER));
    ...
    public void doNotRemoveOnBoundaryDeletesSection() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("IGNORE-WEG-DAMIT", " ", DOESNT_MATTER));
    ...
    public void followOrderOfMatches() throws Exception {
        ...
        cleaner.findMatch(new TextDiffer.NGram("WIRKLICH", " ", DOESNT_MATTER));
        cleaner.findMatch(new TextDiffer.NGram("IGNORE-WEG-DAMIT", " ", DOESNT_MATTER));
