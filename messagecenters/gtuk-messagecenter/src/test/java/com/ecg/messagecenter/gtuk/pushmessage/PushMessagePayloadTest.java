...
public class PushMessagePayloadTest {
    ...
    public void includeAlertCounter() {
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.empty(), Optional.empty());
    ...
    public void includePushServiceSpecificGcmParams() {
        ...
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.of(gcmDetails), Optional.empty());
    ...
    public void includePushServiceSpecificApnsParams() {
        ...
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.empty(), Optional.of(apnsDetails));
