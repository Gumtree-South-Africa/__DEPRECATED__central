...
public class CleanupGumtreeTemplateAdvice extends AbstractCleanupAdvice {
    private static final Pattern[] TOP_TEMPLATE = {Pattern.compile("[\\w\\s]+replied to your ad:"),
                    Pattern.compile("Respond to[\\w\\s]+by replying directly to this email")};
    private static final Pattern[] BOTTOM_TEMPLATE = {Pattern.compile("Already sold it\\?"),
    ...
    private boolean markQuotedFromStartQuotedLine(Pattern[] patterns, Text.Line line,
                    boolean finding) {
