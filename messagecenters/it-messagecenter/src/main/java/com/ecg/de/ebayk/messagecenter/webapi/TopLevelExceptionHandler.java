...
class TopLevelExceptionHandler {
    ...
    public void handle() throws IOException {
        ...
        setStatusAndWriteErrorMessage(ex, response, writer,
                        HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
    }

    private void setStatusAndWriteErrorMessage(Throwable ex, HttpServletResponse response,
                    Writer writer, int statusCode) throws IOException {
