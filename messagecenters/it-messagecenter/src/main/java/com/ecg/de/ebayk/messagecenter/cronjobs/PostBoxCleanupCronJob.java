...
@Component public class PostBoxCleanupCronJob implements CronJobExecutor {
    ...
    @Autowired public PostBoxCleanupCronJob(PostBoxRepository postBoxRepository,
    ...
    @Override public void execute() throws Exception {
        ...
        LOG.info("Deleting PostBoxes untouched for more than {} days: everything before '{}'",
                        cleanupDayBoundary, deletePostBoxesBefore);
    ...
    @Override public String getPreferredCronExpression() {
