 ...
 */
public class KijijiHrefAttributeProcessorTest {

    private KijijiHrefAttributeProcessor p;
    private Map<String, Object> variables;

    @Before public void setUp() {
        p = new KijijiHrefAttributeProcessor("http://kijiji.it");
    ...
    @Test public void testTargetAttributeName() {
        assertThat(p.getTargetAttributeName(null, null, null), is("href"));
    }
