...
public class ItalianTextCleanerTest {
    ...
    @Test public void testGenerateAndCleanupFromSellerToBuyer() throws Exception {
...
//                        contentOf("kijiji/message_with_template_seller_to_buyer.txt"));
    ...
    @Test public void testGenerateAndCleanupFromBuyerToSeller() throws Exception {
        String userMessage = "This is the user message\nBye.";
        Map<String, Object> params = new HashMap<>();
        params.put("message", userMessage);
        params.put("from", "A buyer");
    ...
    @Test public void testMessageWithGreaterThenOnStartOfLine() {
        String userMessage = "This is the user message";
        String messageWithTemplate = new Template("http://siteurl", "http://cdnUrl")
    ...
    @Test public void testMessageWithBreaksShouldBeRepresentedAsNewLine() {
    ...
    @Test public void testFirstMessageFromZapi() {
        String zapiMessage =
    ...
    @Test public void cleanupText() throws Exception {
