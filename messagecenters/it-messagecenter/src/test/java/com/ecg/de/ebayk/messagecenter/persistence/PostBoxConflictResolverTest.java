...
public class PostBoxConflictResolverTest {
    ...
    @Test public void disjunctPostBoxes() {
        ...
        PostBox postBox1 = new PostBox("foo@bar.de", Optional.of(1L),
                        Lists.newArrayList(createConvThread(twoHoursAgo, "a:1")));
        DateTime threeHoursAgo = now().minusHours(5);
        PostBox postBox2 = new PostBox("foo@bar.de", Optional.of(1L),
        ...
        PostBox expected = new PostBox("foo@bar.de", Optional.of(1L),
                        Lists.newArrayList(createConvThread(twoHoursAgo, "a:1"),
    ...
    @Test public void usesLatestThreadVersionWhenInSecondThread() {
        ...
        PostBox postBox1 = new PostBox("foo@bar.de", Optional.of(3L),
                        Lists.newArrayList(createConvThread(threeHoursAgo, "a:1")));
        PostBox postBox2 = new PostBox("foo@bar.de", Optional.of(2L),
                        Lists.newArrayList(createConvThread(twoHoursAgo, "a:1")));

        PostBox resolvedPostBox = resolver.resolve(Lists.newArrayList(postBox1, postBox2));

        PostBox expected = new PostBox("foo@bar.de", Optional.of(3L),
                        Lists.newArrayList(createConvThread(twoHoursAgo, "a:1")));
