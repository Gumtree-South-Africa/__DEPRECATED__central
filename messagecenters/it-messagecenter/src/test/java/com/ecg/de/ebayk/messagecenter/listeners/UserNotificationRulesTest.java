...
import com.ecg.de.ebayk.messagecenter.listeners.UserNotificationRules;
...
public class UserNotificationRulesTest {
    ...
    @Test public void correctNotificationDirectionBasedOnMessageDirection() {
    ...
    @Test public void correctNotificationDirectionBasedOnMessageDirection2() {
        when(message.getState()).thenReturn(MessageState.SENT);
    ...
    @Test public void doNotSentToBuyerOrSellerIfNotInSENTState() {
