...
public class PostBoxConverterTest {
    ...
    @Before public void setUp() throws Exception {
        converter = new PostBoxConverter(PostBoxRepository.POST_BOX);
    }

    @Test public void constructDeconstructPostboxPlainString() {
        ...
        riakObject.setValue(
                        "{\"version\":1,\"threads\":[{\"adId\":\"123\",\"createdAt\":1391368984813,\"modifiedAt\":1391368984875,\"conversationId\":\"abc\",\"containsUnreadMessages\":true,\"receivedAt\":1391365384875},{\"adId\":\"321\",\"createdAt\":1391368984879,\"modifiedAt\":1391368984879,\"conversationId\":\"cba\",\"containsUnreadMessages\":false,\"receivedAt\":1391332984879}]}\n");
    ...
    @Test public void constructDeconstructPostboxGzipped() {
        PostBox postBox = createPostBox();

        PostBoxConverter converter = new PostBoxConverter(PostBoxRepository.POST_BOX);
        IRiakObject riakObject = converter.fromDomain(postBox, new BasicVClock(new byte[] {}));
        riakObject.setValue(GzipAwareContentFilter
                        .compress("{\"version\":1,\"threads\":[{\"adId\":\"123\",\"createdAt\":1391368984813,\"modifiedAt\":1391368984875,\"conversationId\":\"abc\",\"containsUnreadMessages\":true,\"receivedAt\":1391365384875},{\"adId\":\"321\",\"createdAt\":1391368984879,\"modifiedAt\":1391368984879,\"conversationId\":\"cba\",\"containsUnreadMessages\":false,\"receivedAt\":1391332984879}]}\n"));
    ...
    @Test public void receivedAtIsNullSafeDeconstruct() {
        PostBox postBox = new PostBox("bla@blah.com", Optional.of(1l), Lists.newArrayList(
                        new ConversationThread("321", "cba", now(), now(), null, false,
    ...
    private PostBox createPostBox() {
        ...
        return new PostBox("bla@blah.com", Optional.of(1L), Lists.newArrayList(
                        new ConversationThread("123", "abc", createdAt1, modifiedAt1, receivedAt1,
                                        true, Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent()),
                        new ConversationThread("321", "cba", createdAt2, modifiedAt2, receivedAt2,
                                        false, Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent()),
                        new ConversationThread("213", "bca", createdAt3, modifiedAt3, receivedAt3,
                                        false, Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent(), Optional.<String>absent(),
                                        Optional.<String>absent())));
