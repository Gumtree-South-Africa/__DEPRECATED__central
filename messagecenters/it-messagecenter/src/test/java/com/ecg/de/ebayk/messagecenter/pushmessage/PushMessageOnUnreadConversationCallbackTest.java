...
public class PushMessageOnUnreadConversationCallbackTest {
    ...
    @Before public void setUp() {
        ...
        when(conversation.getAdId()).thenReturn("ad_123");
        ...
        listener = new PushMessageOnUnreadConversationCallback(pushService, adInfoLookup,
        ...
        verify(pushService).sendPushMessage(argThat(new ArgumentMatcher<PushMessagePayload>() {
            @Override public boolean matches(Object o) {
                ...
                return json.getString("message").equals("Buyer: message-text") &&
                                !Boolean.parseBoolean((String) json.getJSONObject("gcmDetails")
                                                .get("isRobot")) &&
                                !Boolean.parseBoolean((String) json.getJSONObject("apnsDetails")
                                                .get("isRobot"));
            }
        }));
    }
