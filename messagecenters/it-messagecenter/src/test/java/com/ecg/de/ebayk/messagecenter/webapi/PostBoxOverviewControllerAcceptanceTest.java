...
public class PostBoxOverviewControllerAcceptanceTest extends BaseReplyTsIntegrationTest {
    ...
    @Test public void deleteConversation() {
        ...
        RestAssured.given().expect().statusCode(200).body("body.conversations.size()", equalTo(0))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/seller1@seller.com");
    ...
    @Test public void resetMessageCounter() throws MessagingException {
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread",
                        equalTo(1)) //TODO: There must be still one unread message in the conversation, defect!
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/buyer2@buyer.com?robotEnabled=false");
    }

    @Test public void readConversationWithRobotMessages() throws MessagingException {
        testRule.deliver(aNewMail().from("buyer11@buyer.com").to("seller11@seller.com")
                                        .adId("23232323").plainBody("First contact from buyer."));
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        ...
                        .body("body.conversations[0].textShortTrimmed",
                                        equalTo("First contact from buyer."))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/seller11@seller.com");
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        ...
                        .body("body.conversations[0].textShortTrimmed",
                                        equalTo("First contact from buyer."))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/seller11@seller.com?robotEnabled=false");

        testRule.deliver(aNewMail().from("seller11@buyer.com").to(anonymizedBuyer).adId("23232323")
                                        .header(Header.Robot.getValue(), "GTAU")
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        ...
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/buyer11@buyer.com");

        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        .body("body.conversations.size()", equalTo(1)).body(
                        "body.conversations[0].unread",
                        equalTo(true)) //TODO users would still get the robot message counter
                        .body("body.conversations[0].textShortTrimmed",
                                        equalTo("First contact from buyer."))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/buyer11@buyer.com?robotEnabled=false");
    }

    @Test public void conversationShouldHaveOfferIdWhenTheLastMessageIsOffer()
                    throws MessagingException {
        testRule.deliver(aNewMail().from("buyer13@buyer.com").to("seller13@seller.com")
                                        .adId("232323233").plainBody("I would like to offer $10.")
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        ...
                        .body("body.conversations[0].unread", equalTo(true))
                        .body("body.conversations[0].textShortTrimmed",
                                        equalTo("I would like to offer $10."))
                        .body("body.conversations[0].offerId", equalTo("GTAU"))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/seller13@seller.com");
    }

    @Test public void conversationShouldNotHaveOfferIdWhenTheLastMessageIsNotOffer()
                    throws MessagingException {
        testRule.deliver(aNewMail().from("buyer14@buyer.com").to("seller14@seller.com")
                                        .adId("2323232334").plainBody("I would like to offer $10.")
                                        .header(Header.OfferId.getValue(), "GTAU"));
        String anonymizedBuyer = testRule.waitForMail().getFrom()[0].toString();
        ...
        RestAssured.given().expect().statusCode(200).body("body.numUnread", equalTo(1))
                        ...
                        .body("body.conversations[0].offerId", equalTo("GTAU"))
                        .get("http://localhost:" + testRule.getHttpPort()
                                        + "/ebayk-msgcenter/postboxes/seller14@seller.com");

        testRule.deliver(
                        aNewMail().from("seller14@buyer.com").to(anonymizedBuyer).adId("2323232334")
