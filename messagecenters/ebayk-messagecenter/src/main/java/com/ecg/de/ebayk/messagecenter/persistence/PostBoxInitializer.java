...
public class PostBoxInitializer {
    ...
    public void moveConversationToPostBox(
        ...
        finalThreads.add(
                new ConversationThread(
                        ...
                        Optional.fromNullable(Iterables.getLast(conversation.getMessages()).getMessageDirection().name()),
    ...
    private Optional<Long> lookupNegotiationId(Conversation conversation) {
        ...
        return customValueNegotiationId == null ? Optional.<Long>absent() : Optional.of(Long.valueOf(customValueNegotiationId));
    }
