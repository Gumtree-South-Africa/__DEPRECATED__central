...
import static com.ecg.de.ebayk.messagecenter.util.PushNotificationTextShortener.shortenText;
...
public class PushNotificationTextShortenerTest {
    ...
    public void removeFirstContactPosterTemplateText() {
        String shortened = shortenText(FIRST_TEXT);
    ...
    public void removeStartLine(){
        ...
        String shortened = shortenText(s);
    ...
    public void removeFirstContactPosterTemplateText2() {
        String shortened = shortenText(LATER_ANSWERS_TEXT_2);
    ...
    public void removeQuotePartsOfMessage() {
        String shortened = shortenText(LATER_ANSWERS_TEXT);
    ...
    public void stripsHagglingFromContactPoster() {
        assertEquals("Hello", shortenText(MESSAGEBOX_HAGGLING_CP_TEXT));
    }

    @Test
    public void stripsHagglingFromReply() {
        assertEquals("und noch ein angebot!", shortenText(MESSAGEBOX_HAGGLING_REPLY_TEXT));
    }
}
