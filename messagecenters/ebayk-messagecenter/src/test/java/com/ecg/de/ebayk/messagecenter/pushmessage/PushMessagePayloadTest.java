...
public class PushMessagePayloadTest {
    ...
    public void includeAlertCounter() {
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.<Map<String, String>>absent(), Optional.<Map<String, String>>absent());
    ...
    public void includePushServiceSpecificGcmParams() {
        ...
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.of(gcmDetails), Optional.<Map<String, String>>absent());
    ...
    public void includePushServiceSpecificApnsParams() {
        ...
        PushMessagePayload payload = new PushMessagePayload("a", "b", "c", ImmutableMap.of("a1", "1"), Optional.of(10), Optional.<Map<String, String>>absent(), Optional.of(apnsDetails));
