...
import static com.ecg.messagecenter.ebayk.webapi.responses.MessageResponse.Attachment;
...
public class AttachmentTest {
    ...
    public void escapesFilenamesCorrect() {
        assertEquals("/screeningv2/mail/123/INBOUND/parts/foo%20bar.jpg", new Attachment("foo bar.jpg", "123").getUrl());
    }
