...
import com.ecg.de.mobile.replyts.rating.svc.DealerRatingService.DealerRatingServiceClient;
...
public final class DealerRatingServiceTest {
    ...
    private final DealerRatingServiceClient client = mock(DealerRatingServiceClient.class);
