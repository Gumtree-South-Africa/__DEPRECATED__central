...
public class MessageBodyAnonymizerConfig {
    ...
    @Autowired
    public MessageBodyAnonymizerConfig(@Value("gumtree.anonymizer.knowngoodinsertfooter") String knownGoodInsertFooterFormat, @Value("gumtree.anonymizer.safetytext") String safetyTextFormat, @Value("gumtree.anonymizer.knowngoodsellersafetytext") String knownGoodSellerSafetyTextFormat) {
