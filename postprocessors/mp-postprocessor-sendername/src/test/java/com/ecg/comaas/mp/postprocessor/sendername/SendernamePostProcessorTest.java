...
import com.ecg.comaas.mp.postprocessor.sendername.SendernamePostProcessor;
...
public class SendernamePostProcessorTest {
    ...
    private void setUpCompleteSendernamePostProcessorConfig() {
        sendernamePostProcessor = new SendernamePostProcessor(simpleBuyerNamePattern, simpleSellerNamePattern);
    }
}