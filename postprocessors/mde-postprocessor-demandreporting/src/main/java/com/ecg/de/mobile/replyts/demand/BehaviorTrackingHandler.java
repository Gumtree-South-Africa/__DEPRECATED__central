...
public class BehaviorTrackingHandler {
    ...
    public BehaviorTrackingHandler(Config config, EventPublisherFactory factory) {
    ...
    public EmailContactEvent createTrackingEventFromContext(MessageProcessingContext context) {
