...
cqlsh ${HOST} 9042 -k "$KEYSPACE" -f messagecenters/core-messagecenter/src/main/resources/cassandra_messagebox_schema.cql
cqlsh ${HOST} 9042 -k "$KEYSPACE" -f messagecenters/core-messagecenter/src/main/resources/cassandra_messagecenter_schema.cql
