/*
 * Copied from http://code.google.com/p/google-diff-match-patch/source/checkout
 * on 2013-04-18 15:59.
 */
/*
...
import static com.ecg.replyts.app.textcleanup.DiffMatchPatch.Diff;
import static com.ecg.replyts.app.textcleanup.DiffMatchPatch.LinesToCharsResult;
import static com.ecg.replyts.app.textcleanup.DiffMatchPatch.Patch;
...
public class DiffMatchPatchTest extends TestCase {
    ...
    private static LinkedList<Diff> diffList(Diff... diffs) {
        ...
        Collections.addAll(myDiffList, diffs);
        return myDiffList;
    }
}
