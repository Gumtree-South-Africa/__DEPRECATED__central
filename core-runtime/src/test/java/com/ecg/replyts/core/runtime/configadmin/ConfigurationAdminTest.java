...
public class ConfigurationAdminTest {
    ...
    public void createsNewConfiguration() throws Exception {
        PluginConfiguration baseConf = PluginConfiguration.createWithRandomUuid(new ConfigurationId(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
    ...
    public void overridesConfiguration() {
        PluginConfiguration baseConf = PluginConfiguration.createWithRandomUuid(new ConfigurationId(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(baseConf);
        PluginConfiguration newConf = PluginConfiguration.createWithRandomUuid(new ConfigurationId(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
    ...
    public void mergesConfiguration() {
        PluginConfiguration baseConf = PluginConfiguration.createWithRandomUuid(new ConfigurationId(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(baseConf);
        PluginConfiguration newConf = PluginConfiguration.createWithRandomUuid(new ConfigurationId(FACTORY2, "inst1"), 200, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(newConf);
