...
public class ConfigurationAdminTest {
    ...
    public void createsNewConfiguration() throws Exception {
        PluginConfiguration baseConf = new PluginConfiguration(new ConfigurationLabel(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
    ...
    public void overridesConfiguration() {
        PluginConfiguration baseConf = new PluginConfiguration(new ConfigurationLabel(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(baseConf);
        PluginConfiguration newConf = new PluginConfiguration(new ConfigurationLabel(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
    ...
    public void mergesConfiguration() {
        PluginConfiguration baseConf = new PluginConfiguration(new ConfigurationLabel(FACTORY1, "inst1"), 100, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(baseConf);
        PluginConfiguration newConf = new PluginConfiguration(new ConfigurationLabel(FACTORY2, "inst1"), 200, PluginState.ENABLED, 1L, JsonObjects.newJsonObject());
        admin.putConfiguration(newConf);
