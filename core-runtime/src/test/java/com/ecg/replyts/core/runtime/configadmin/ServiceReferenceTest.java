...
public class ServiceReferenceTest {
    ...
    public void doesAscendingOrder() throws Exception {
        PluginInstanceReference<Object> higherPrio = new PluginInstanceReference<>(PluginConfiguration.createGeneratingUuid(new ConfigurationId(ConfigurationTest.IDENTIFIER, "ins1"), 400, null, 1l, null), null);
        PluginInstanceReference<Object> lowerPrio = new PluginInstanceReference<>(PluginConfiguration.createGeneratingUuid(new ConfigurationId(ConfigurationTest.IDENTIFIER, "ins1"), 200, null, 1l, null), null);
