...
public class RefresherTest {
    ...
    private PluginConfiguration pluginConfiguration(String identifier, String instanceId, long version) {
        return PluginConfiguration.createNewPluginConfiguration(new ConfigurationLabel(identifier, instanceId), 1l, PluginState.ENABLED, version, JsonObjects.newJsonObject());
    }
