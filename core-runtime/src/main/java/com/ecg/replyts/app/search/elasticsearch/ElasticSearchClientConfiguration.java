...
public class ElasticSearchClientConfiguration {
    ...
    public RestClient elasticRestClient(
            ...
            @Value("${search.es.username:#{systemEnvironment['ESAAS_USERNAME'] ?: 'not_used'}}") String username,
            @Value("${search.es.password:#{systemEnvironment['ESAAS_PASSWORD'] ?: 'not_used'}}") String password
    ) {
