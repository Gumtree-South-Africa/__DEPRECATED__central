 ...
 */
class ContentTransferEncodingMultipartFix {
    private static final Set<String> ALLOWED_ENCODINGS_FOR_MULTIPART = new HashSet<String>(Arrays.asList("binary", "7bit", "8bit"));
