...
public class QuietReadOnlyRiakConversationRepository extends RiakConversationRepository  {
    ...
    public QuietReadOnlyRiakConversationRepository(IRiakClient riakClient) {
        this(riakClient, DEFAULT_BUCKET_NAME, DEFAULT_SECRET_BUCKET_NAME, DEFAULT_INDEX_BUCKET_NAME);
    }

    public QuietReadOnlyRiakConversationRepository(IRiakClient riakClient, String bucketNamePrefix) {
    ...
    public QuietReadOnlyRiakConversationRepository(IRiakClient riakClient, String bucketName, String secretBucketName, String indexBucketName) {
