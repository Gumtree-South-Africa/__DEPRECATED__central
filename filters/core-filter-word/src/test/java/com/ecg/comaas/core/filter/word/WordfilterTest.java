...
public class WordfilterTest {
    ...
    public void firesWithZeroScoreifDupliateIsFoundOnIgnoreDuplicates() {
        ...
        when(previousMessage.getProcessingFeedback()).thenReturn(Arrays.<ProcessingFeedback>asList(new ImmutableProcessingFeedback(WordfilterFactory.IDENTIFIER, "sampleinstance", "FooStr[a-z]*", "desc", 100, FilterResultState.OK, false)));
