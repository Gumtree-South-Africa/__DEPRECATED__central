...
public class BlockedAdFilterConfiguration {
    ...
    public DataSource adDataSource(
        ...
        @Value("${replyts2-belenblockedadfilter-plugin.dataSource.pool.c3p0.maxPoolSize:100}") int maxPoolSize,
        @Value("${replyts2-belenblockedadfilter-plugin.dataSource.pool.c3p0.acquireIncrement:5}") int acquireIncrement,
