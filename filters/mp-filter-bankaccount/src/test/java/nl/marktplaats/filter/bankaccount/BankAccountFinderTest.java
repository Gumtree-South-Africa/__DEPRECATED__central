...
public class BankAccountFinderTest {
    private BankAccountFinder finder = new BankAccountFinder(new BankAccountFilterConfiguration(asList(
            "123456",
            "942766011",
    ...
    @Test public void findNothing() {
        ...
        assertTrue(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID).isEmpty());
    }

    @Test public void findLiteralBankAccount() {
        String text = "Maak aub geld over aan rekening 123456.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItems(new BankAccountMatch("123456", "123456", 100)));
    }

    @Test public void findDottedBankAccount() {
        String text = "Maak aub geld over aan rekening 12.34.56.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("123456", "12.34.56", 100)));
    }
    ...
    @Test public void findLowCertaintyLiteralBankAccount() {
        ...
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("123456", "123456", 50)));
    }

    @Test public void findLowCertaintySpacedBankAccount() {
        String text = "Maak aub geld over aan rekening 12 34 56 94 3.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("123456", "12 34 56", 50)));
    }

    @Test public void findLiteralLocalBankAccountFromIban() {
        String text = "Maak aub geld over aan rekening 654321.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("NL12INGP0000654321", "654321", 100)));
    }

    @Test public void findSpacedLocalBankAccountFromIban() {
        String text = "Maak aub geld over aan rekening 65 43 21.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("NL12INGP0000654321", "65 43 21", 100)));
    }

    @Test public void findLiteralIbanBankAccount() {
        String text = "Maak aub geld over aan rekening NL12INGP0000654321.";
        List<BankAccountMatch> matches = finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID);
    ...
    @Test public void findLowCertaintyMatchOnOnlyLeadingZeros() {
        ...
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("DE05100205000003287300", "3 2873 00", 100)));
    }

    @Test public void findLowCertaintyMatchOnSerialNumber() {
        String text = "The ipod has serial number OBKKL0500 0003 2873 00.";
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("DE05100205000003287300", "3 2873 00", 50)));
    }
    ...
    @Test public void findLowCertaintyMatchOnSerialNumberWithTrailingNumbers() {
        ...
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("DE05100205000003287300", "3287300", 50)));
    }
    ...
    @Test public void findLowCertaintyMatchWithReallyALotOfSeparators() {
        ...
        assertThat(finder.findBankAccountNumberMatches(singletonList(text), PLATFORM_AD_ID), hasItem(new BankAccountMatch("942766011", "9     4     2     7     6     6     0     1     1", 50)));
    }
    ...
    @Test public void findInMultipleTextsHasNoDuplicates() {
    ...
    @Test public void containsSingleBankAccountNumber_FindsNothing() {
    ...
    @Test public void containsSingleBankAccountNumber_FindsLocalAccount() {
        List<String> texts = asList("ok", "suspect 123456");
        List<BankAccountMatch> matches = finder.containsSingleBankAccountNumber("123456", texts, PLATFORM_AD_ID);
        assertThat(matches, hasItem(new BankAccountMatch("123456", "123456", 100)));
    }

    @Test public void containsSingleBankAccountNumber_FindsIbanAccount() {
    ...
    @Test public void containsSingleBankAccountNumber_doesNotFindOtherKnownAccounts() {
        List<String> texts = asList("ok", "other suspect: GB29NWBK60161331926819");
        List<BankAccountMatch> matches = finder.containsSingleBankAccountNumber("NL12INGP0000654321", texts, PLATFORM_AD_ID);
        assertThat(matches.size(), is(0));
    }

    @Test public void containsSingleBankAccountNumber_ignoresOtherKnownAccounts() {
