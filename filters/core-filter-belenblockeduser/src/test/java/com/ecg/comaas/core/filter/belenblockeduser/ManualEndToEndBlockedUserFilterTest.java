...
import com.ecg.comaas.core.filter.belenblockeduser.BlockedUserFilterConfiguration;
import com.ecg.comaas.core.filter.belenblockeduser.BlockedUserFilterFactory;
...
@ContextConfiguration(classes = BlockedUserFilterConfiguration.class)
