...
class Ip2CountryFilter implements Filter {
    ...
    Ip2CountryFilter(Ip2CountryRules countryRules, Ip2CountryResolver resolver, IpAddressExtractor extractor) {
    ...
    public List<FilterFeedback> filter(MessageProcessingContext messageProcessingContext) {
        ...
        LOG.debug("IP {} is from country {}", ipStr.get(), resolveCountryCode.orElse("UNRESOLVABLE"));
