...
public class GumtreeGeoIpLookupFilterTest {
    ...
    public void testForSouthAfricanIp() throws Exception {
        ...
        assertEquals("{\"filterVersion\":\"\",\"filterName\":\"com.ecg.comaas.gtuk.filter.geoiplookup.GumtreeGeoIpLookupFilter\",\"description\":\"ZA\"}", feedbacks.get(0).getDescription());
    ...
    public void testForGermanIp() throws Exception {
        ...
        assertEquals(1, feedbacks.size());
        assertEquals(FilterResultState.HELD, feedbacks.get(0).getResultState());
        assertEquals("{\"filterVersion\":\"\",\"filterName\":\"com.ecg.comaas.gtuk.filter.geoiplookup.GumtreeGeoIpLookupFilter\",\"description\":\"DE\"}", feedbacks.get(0).getDescription());
    }
    ...
    public void testForNigerianIp() throws Exception {
        ...
        assertEquals(1, feedbacks.size());
        assertEquals(FilterResultState.HELD, feedbacks.get(0).getResultState());
        assertEquals("{\"filterVersion\":\"\",\"filterName\":\"com.ecg.comaas.gtuk.filter.geoiplookup.GumtreeGeoIpLookupFilter\",\"description\":\"NG\"}", feedbacks.get(0).getDescription());
    }
