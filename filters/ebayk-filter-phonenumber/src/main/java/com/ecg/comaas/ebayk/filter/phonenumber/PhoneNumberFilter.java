...
class PhoneNumberFilter implements Filter {
    ...
    public List<FilterFeedback> filter(MessageProcessingContext context) {
        ...
        Set<PhoneNumberFilterConfiguration.PhoneNumberConfiguration> matchedNumbers = new HashSet<>();
    ...
    private void findInSubject(MessageProcessingContext context, Set<PhoneNumberFilterConfiguration.PhoneNumberConfiguration> matchedNumbers) {
    ...
    private void findInHtmlLinks(MessageProcessingContext context, Set<PhoneNumberFilterConfiguration.PhoneNumberConfiguration> matchedNumbers) {
    ...
    private void findInPlainTextParts(MessageProcessingContext context, Set<PhoneNumberFilterConfiguration.PhoneNumberConfiguration> matchedNumbers) {
    ...
    private void findInNumberStream(Set<PhoneNumberFilterConfiguration.PhoneNumberConfiguration> matchedNumbers, NumberStream numberStream) {
        for (PhoneNumberFilterConfiguration.PhoneNumberConfiguration config : this.config.getFraudulentPhoneNumbers()) {
