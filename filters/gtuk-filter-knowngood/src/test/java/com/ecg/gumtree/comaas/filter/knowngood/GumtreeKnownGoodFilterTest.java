...
public class GumtreeKnownGoodFilterTest {
    ...
    public void testKnownGoodBuyerFirstMessage() {
        ...
        assertEquals("{\"filterVersion\":\"\",\"filterName\":\"com.ecg.gumtree.comaas.filter.knowngood.GumtreeKnownGoodFilter\",\"description\":\"Sender is known good\"}", feedbacks.get(0).getDescription());
    }
