...
public class CassandraConfigurationRepositoryIntegrationTest {
    ...
    public void shouldInsertAndReadConfiguration() {
        ...
        PluginConfiguration configuration = PluginConfiguration.createGeneratingUuid(id, 1, PluginState.ENABLED, 1, new TextNode("some_json"));
    ...
    public void shouldUpdateConfiguration() {
        ...
        PluginConfiguration configuration2 = PluginConfiguration.createGeneratingUuid(sameId, 2, PluginState.DISABLED, 2, new TextNode("other_json"));
