...
@Ignore("akobiakov: the test fails on jenkins because of not suitable defaults in the SwiftAttachmentRepository. Needs discussion")
...
public class AttachmentRepositoryIntegrationTest {
    ...
    public void extractsAttachmentNames() throws IOException, ParsingException {
        Mail mail = parse();
        Files.write(Paths.get("att.jpeg"), mail.getAttachment(attName).getContent());
